...
local _2amodule_name_2a = "nvim-startify.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("nvim-startify.aniseed.core"), autoload("nvim-startify.aniseed.fs"), autoload("nvim-startify.aniseed.nvim"), autoload("nvim-startify.aniseed.string")
...
local function impl()
  local compiler = require("nvim-startify.aniseed.deps.fennel")
