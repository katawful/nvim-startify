...
local _2amodule_name_2a = "nvim-startify.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("nvim-startify.aniseed.core"), autoload("nvim-startify.aniseed.compile"), autoload("nvim-startify.aniseed.fennel"), autoload("nvim-startify.aniseed.fs"), autoload("nvim-startify.aniseed.nvim")
