...
local _2amodule_name_2a = "nvim-startify.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("nvim-startify.aniseed.core"), autoload("nvim-startify.aniseed.env"), autoload("nvim-startify.aniseed.eval"), autoload("nvim-startify.aniseed.nvim")
