...
local _2amodule_name_2a = "nvim-startify.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("nvim-startify.aniseed.core"), autoload("nvim-startify.aniseed.fennel"), autoload("nvim-startify.aniseed.fs"), autoload("nvim-startify.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "nvim-startify.aniseed.macros"
  local filename
  do
