...
local _2amodule_name_2a = "nvim-startify.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("nvim-startify.aniseed.compile"), autoload("nvim-startify.aniseed.fennel"), autoload("nvim-startify.aniseed.fs"), autoload("nvim-startify.aniseed.nvim")
