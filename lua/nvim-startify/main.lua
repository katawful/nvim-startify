...
local autocmd, command, fortune, map, _, _0 = autoload("nvim-startify.utils.autocmd"), autoload("nvim-startify.utils.command"), autoload("nvim-startify.fortune.init"), autoload("nvim-startify.utils.map"), nil, nil
